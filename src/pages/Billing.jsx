            ...
            <div className="grid gap-6 md:grid-cols-3">
              {plans.map((plan) => (
                <Card key={plan.name} className={`relative ${
                  ...
                  {plan.current && (
                    <Badge variant="outline" className="absolute -top-2 left-1/2 -translate-x-1/2 border-green-500 text-green-600">
                      Current Plan
                    </Badge>
                  )}
          ...
          <div className="grid gap-6 md:grid-cols-2">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{usage.teamMembers.used} / {usage.teamMembers.limit}</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className="bg-purple-500 h-2 rounded-full"
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your upcoming charges and billing details</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                ...
                <div className="bg-muted/50 p-4 rounded-lg space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your subscription automatically renews on {new Date(currentPlan.nextBilling).toLocaleDateString()}.
